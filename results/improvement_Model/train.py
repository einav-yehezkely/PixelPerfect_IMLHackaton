...
# dataset/train_set/validation
DATA_ROOT = PROJECT_ROOT / "dataset" / "train_set"

# Save weights inside submissions/my_team/
...
def main():
    ...
    # Train augmentations:
    # These help the model become more robust to small changes in the image.
    ...
    # We do not use random augmentations here.
